 ...
 */
export const nextWeekDates = compose(
  weeklyDateRange,
  nextWeekMonday
)
...
export const formatDateTime = (date, format) =>
  getTZDate(date).format('YYYY-MM-DDTHH:mm')

export const formatDate = (date, format) => getTZDate(date).format('YYYY-MM-DD')
...
export const uiFirendlyFormat = (date, format) => getTZDate(date).format(format)
